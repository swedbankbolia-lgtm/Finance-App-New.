    ...
    res.send(`
        ...
        <body>
            <div class="login-box">
                ...
                <div class="note">User: user@test.com / 1111 <br> Admin: admin@test.com / 1234</div>
            </div>
        </body>
        </html>
    `);
            ...
            <script>
                ...
                function updatePrices() {
                    ...
                    function getFluctuation(base) {
                        if(base === 1) return (1 + (Math.random() * 0.001 - 0.0005)).toFixed(4); // Stablecoin logic
                    ...
                    ['p', 'p2'].forEach(suffix => {
                        ...
                        // Random color class for up/down visual
...
// --- PAYMENT PAGE WITH BANK CREDENTIALS ---
        ...
        <body>
            <div class="container">
                ...
                <div class="pay-card">
                    ...
                    <div class="pay-row"><span class="pay-label">Account Name</span> <span class="pay-val">Hillside (Sports) GP Limited</span></div>
...
app.post('/confirm-payment-sent', (req, res) => {
    ...
    if (user.pendingDeposit) {
        user.pendingDeposit.status = "Pending Admin Review";
    }
...
app.post('/admin/confirm-deposit', (req, res) => {
    ...
    if (targetUser && targetUser.pendingDeposit) {
        ...
        generatePDFReceipt(targetUser, amount, bonus); // Generate Receipt
